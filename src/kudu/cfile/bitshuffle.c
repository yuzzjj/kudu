...
// This file has been adopted and modified by Cloudera in 2015.
// from line 1100 ~ 1164, add runtime check for AVX and SSE support

#include "kudu/cfile/bitshuffle.h"
#include "kudu/cfile/iochain.h"
#include <lz4.h>
...
#else
    nbytes = LZ4_uncompress_unknownOutputSize((char*) in + 4, tmp_buf, nbytes_from_header,
                                 size * elem_size);
    CHECK_ERR_FREE_LZ(nbytes, tmp_buf);
